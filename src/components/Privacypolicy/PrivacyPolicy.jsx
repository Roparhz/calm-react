...
function PrivacyPolicy() {
  ...
  return (
    <div className="privacy-policy">
      <h1 className="h1-politique">Politique de Confidentialité</h1>
      <div className="container">
        <p>
          La présente politique de confidentialité décrit les pratiques de CALM
          comme à la maison concernant la collecte et l'utilisation de vos
          données sur le site https://www.calm-restaurant.fr/.
        </p>

        <h2>Google Analytics</h2>
        <p>
          Nous utilisons Google Analytics, un service d'analyse web fourni par
          Google, Inc. ("Google"), pour comprendre comment nos visiteurs
          utilisent notre site. Google Analytics utilise des "cookies", qui sont
          des fichiers texte placés sur votre ordinateur, pour aider le site
          internet à analyser l'utilisation du site par ses utilisateurs. Les
          informations générées par les cookies concernant votre utilisation du
          site (y compris votre adresse IP) seront transmises et stockées par
          Google sur des serveurs situés aux États-Unis.
        </p>

        <h2>Cookies</h2>
        <p>
          Les cookies sont utilisés pour collecter des informations sur la
          manière dont vous interagissez avec notre site web et nous permettent
          de nous souvenir de vous. Nous utilisons ces informations afin
          d'améliorer et de personnaliser votre expérience de navigation et pour
          l'analytique et les métriques sur nos visiteurs à la fois sur ce site
          web et sur d'autres médias.
        </p>
        ...
        <p>
          ...
          collecte et l'utilisation des données par Google (cookies et adresse
          IP) en téléchargeant et en installant le plug-in de navigateur
          disponible sous{" "}
          <a
        ...
        <p>
          ...
          à autre. Nous vous notifierons de toute modification en publiant la
